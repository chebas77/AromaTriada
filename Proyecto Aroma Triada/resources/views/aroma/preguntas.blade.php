...
<section class="container mx-auto py-12 px-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    <!-- Category 1 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 1</h3>
      <div class="space-y-4">
    ...
    <!-- Category 2 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 2</h3>
      <div class="space-y-4">
        <details class="bg-white shadow p-4 rounded">
    ...
    <!-- Category 3 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 3</h3>
      <div class="space-y-4">
        <details class="bg-white shadow p-4 rounded">
    ...
    <!-- Category 4 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 4</h3>
      <div class="space-y-4">
        <details class="bg-white shadow p-4 rounded">
    ...
    <!-- Category 5 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 5</h3>
      <div class="space-y-4">
        <details class="bg-white shadow p-4 rounded">
    ...
    <!-- Category 6 -->
    <div>
      <h3 class="text-xl font-bold mb-4">Categoría 6</h3>
      <div class="space-y-4">
        <details class="bg-white shadow p-4 rounded">
