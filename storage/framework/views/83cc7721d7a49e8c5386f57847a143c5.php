  ...
  <div class="container mx-auto text-center">
    <div class="flex flex-col items-center">
      ...
      <?php if(Auth::check()): ?>
        ...
        <p class="text-gray-700 mt-2"><?php echo e(Auth::user()->email); ?></p>
      <?php else: ?>
        ...
        <div class="mt-4 flex gap-4">
          <a href="<?php echo e(route('aroma.inicioSesion')); ?>" class="bg-black text-white px-4 py-2 rounded font-bold hover:bg-gray-800">Iniciar Sesión</a>
          <a href="<?php echo e(route('aroma.registro')); ?>" class="bg-black text-white px-4 py-2 rounded font-bold hover:bg-gray-800">Regístrate</a>
        </div>
      <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <aside class="bg-white shadow-lg rounded-lg p-6">
        ...
        <ul class="space-y-2">
          ...
          <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-red-500 hover:text-red-700 font-medium">Cerrar Sesión</a></li>
        </ul>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3135370373-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3135370373-1', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('recursos.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sebas\Desktop\AromaTriada\Proyecto Aroma Triada\resources\views/aroma/perfil.blade.php ENDPATH**/ ?>