  ...
  <section class="bg-cover bg-center py-48 text-center" style="background-image: url(<?php echo e(asset('images/navidadfondo.jpg')); ?>); background-size: cover; background-position: center;">
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide bg-white shadow p-4 rounded relative group">
        <!-- Imagen del producto -->
        <img src="<?php echo e(asset($producto->imagen)); ?>" alt="<?php echo e($producto->nombre); ?>" class="h-40 w-full object-cover mb-4 group-hover:opacity-40 transition duration-300">
        
        <!-- Información del producto -->
        <!--<h3 class="text-sm font-bold text-gray-500"><?php echo e($producto->categoria->nombre ?? 'Sin categoría'); ?></h3>-->
        ...
        <a href="<?php echo e(route('detalle.item', ['tipo' => 'producto', 'id' => $producto->id_producto])); ?>" class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-red-600 text-white py-2 px-6 rounded opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:scale-100 group-hover:translate-y-10">
          Comprar
        </a>
      </div>
...
<script>
 ...
 <section class="container mx-auto py-12 px-8 text-center">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    <!-- Category 1: TORTAS -->
    <a href="<?php echo e(route('aroma.catalogo', ['categorias' => [1]])); ?>" class="relative group bg-white shadow rounded overflow-hidden">
      <img src="<?php echo e(asset('images/1.jpg')); ?>" alt="TORTAS" class="w-full h-96 object-cover group-hover:opacity-80 transition duration-300">
    ...
    <a href="<?php echo e(route('aroma.catalogo', ['categorias' => [2]])); ?>" class="relative group bg-white shadow rounded overflow-hidden">
      <img src="<?php echo e(asset('images/2.jpg')); ?>" alt="BOCADITOS" class="w-full h-96 object-cover group-hover:opacity-80 transition duration-300">
      <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-0 group-hover:opacity-40 transition duration-300">
        <span class="text-white font-bold text-lg">Ver los productos</span>
      </div>
      <div class="p-4">
    ...
    <!-- Category 3: BOXES -->
    <a href="<?php echo e(route('aroma.catalogo', ['categorias' => [3]])); ?>" class="relative group bg-white shadow rounded overflow-hidden">
      <img src="<?php echo e(asset('images/3.jpg')); ?>" alt="BOXES" class="w-full h-96 object-cover group-hover:opacity-80 transition duration-300">
      <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-0 group-hover:opacity-40 transition duration-300">
        <span class="text-white font-bold text-lg">Ver los productos</span>
      </div>
      <div class="p-4">
  ...
  <section class="bg-gray-200 py-16 text-center">
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <a href="<?php echo e(route('aroma.nosotros')); ?>" class="bg-black text-white px-6 py-2 font-bold rounded hover:bg-gray-800">
        Ver Más
      </a>
    </div>
  </section>
  ...
  <section class="container mx-auto py-16 px-6 text-center">
    <div class="bg-gradient-to-r from-gray-200 to-gray-400 p-12 rounded-lg shadow-md">
      ...
      <button onclick="window.location.href=<?php echo e(route('aroma.catalogo')); ?>"
  ...
  <section class="container mx-auto py-12 px-6 text-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-gray-300 h-40 rounded overflow-hidden transform transition duration-300 hover:scale-105">
        <img src="<?php echo e(asset('images/product1.jpg')); ?>" alt="Producto 1" class="w-full h-full object-cover">
      </div>
      <div class="bg-gray-300 h-40 rounded overflow-hidden transform transition duration-300 hover:scale-105">
        <img src="<?php echo e(asset('images/product2.jpg')); ?>" alt="Producto 2" class="w-full h-full object-cover">
      </div>
      <div class="bg-gray-300 h-40 rounded overflow-hidden transform transition duration-300 hover:scale-105">
        <img src="<?php echo e(asset('images/product3.jpg')); ?>" alt="Producto 3" class="w-full h-full object-cover">
      </div>
      <div class="bg-gray-300 h-40 rounded overflow-hidden transform transition duration-300 hover:scale-105">
        <img src="<?php echo e(asset('images/product4.jpg')); ?>" alt="Producto 4" class="w-full h-full object-cover">
      </div>
...
<?php echo $__env->make('recursos.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sebas\Desktop\AromaTriada\Proyecto Aroma Triada\resources\views/aroma/index.blade.php ENDPATH**/ ?>